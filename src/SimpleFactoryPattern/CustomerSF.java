...
public class CustomerSF {
    ...
    public CustomerSF(String firstName, String lastName, String tcId, String phoneNumber, char gender) {
    ...
    public CustomerSF(String firstName, String lastName, String tcId, String phoneNumber, boolean isMarried, boolean hasCriminalRecord, char gender) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.tcId = tcId;
        this.phoneNumber = phoneNumber;
